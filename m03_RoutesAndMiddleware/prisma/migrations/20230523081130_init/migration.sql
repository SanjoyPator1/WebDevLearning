...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_prductId_fkey" FOREIGN KEY ("prductId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
