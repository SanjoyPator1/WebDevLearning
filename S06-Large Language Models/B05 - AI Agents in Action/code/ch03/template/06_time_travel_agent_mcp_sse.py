...
#   1. Opens `MCPServerStreamableHttp(name="Time Tracker Server",
...
#      with the SAME instructions as 05_time_travel_agent.py's agent
#      (load_journal first, record_event per new entry, output everything
#      when asked for a summary). Pass the opened server in
#      `mcp_servers=[...]`.
